...
class ChatGenerationCallback(CustomTensorBoardCallback):
    def __init__(
                ...
                max_new_tokens=256, generate=False, config=None, prompt_type='short'
                ):
    ...
    def on_train_begin(self, args, state, control, model=None, **kwargs):
        ...
        format_chat_template_ = lambda row: format_chat_template(row, self.tokenizer, self.generate, markup=None, prompt_type=self.prompt_type)
